...
# $Header: /var/cvsroot/gentoo-x86/x11-wm/i3/i3-4.0.1-r2.ebuild,v 1.1 2011/08/04 08:59:41 xarthisius Exp $

EAPI=4

inherit base versionator toolchain-funcs

DESCRIPTION="An improved dynamic tiling window manager (git version)"
HOMEPAGE="http://i3wm.org/"
SRC_URI="http://code.i3wm.org/i3/snapshot/i3-master.tar.bz2"
